...
**Datengrenzen:** Erfasst/Produktpflege zählen eindeutige Produkte je Konto; Einlagerung zählt Buchungen, Pick/Pack zählen Vorgänge. Historische gemeinsame Konten werden nicht rückwirkend Personen zugerechnet. Erfassen und Pflege desselben Produkts durch dasselbe Konto im Zeitraum erhalten nur Erfassungspunkte (Rohzahlen bleiben erhalten). Historische/deaktivierte Konten erhalten keine persönliche Bewertung und gehören nicht zum Nenner des Teamanteils. Dieser bleibt bei Suche/Filter unverändert. Backend-Protokollabfragen sind begrenzt; additive `dataQuality` weist Fehler und nicht sicher abgedeckte Zeiträume aus. Ohne bestätigte Abdeckung aller Quellen und geladenes Kontoverzeichnis keine Gesamtpunkte/Rangfolge. Fehlende Quellen zeigen Striche statt Null. Ein Wert von 0 beweist keine Untätigkeit. Autorisierung unverändert.
