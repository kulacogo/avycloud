...
|---|---|---|---|---|---|
| Produktbilder: Studio und Varianten | [product-images.md](product-images.md) | `backend/services/image-studio.js`, `backend/services/image-generation.js`, `backend/lib/image-result-check.js` | `components/ProductSheet.tsx` | Betreiberreferenz 18.09.2026 | Fotografische Verbesserungen, 18.09.2026 |
