...
Betreiberanforderung: Möbel müssen nicht für Produktfotos aufgebaut werden. Der Galerieknopf zur KI-Bildergenerierung recherchiert automatisch, wenn die eigenen Fotos nur Verpackung/Etiketten und keine brauchbare Gesamtansicht zeigen. Bereits vorhandene WEB-Bilder sind in diesem Fall kein ungeprüfter Ersatz. `Studio-Foto` bleibt die Bearbeitung des gezielt ausgewählten Fotos; die automatische Recherche gehört zur Galerie-/Variantenfunktion.
