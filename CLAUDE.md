...
- `ALLOW_BUCHERSENDUNG=false` (default) — erlaubt `dp:buchersendung` als Produkt „Büchersendung". NUR einschalten, wenn der DP-Vertrag Büchersendung für den Warenkorb erlaubt (rechtlich nur Bücher/Medien). Ohne Flag wird Büchersendung nie angeboten.
