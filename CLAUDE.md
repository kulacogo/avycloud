...
- Katalog-Codes (verifiziert via Prod-Logs 2026-07-22): Warensendung=`dp:bucherwarensendung`, Maxibrief=`dp:maxibrief`, Kleinpaket=`dhl_de:warenpost`, DHL Paket=`dhl_de:dhl_paket`, DPD Classic=`dpd:classic`. **Großbrief:** einfacher nationaler Großbrief wird auf diesem SendCloud-Konto NICHT angeboten (nur `dp:grossbrief_integral` = mit Einschreiben, bewusst ausgeschlossen) → erscheint nicht im Pack-Flow; offene Owner-Entscheidung, wie Großbrief frankiert wird.
