...
const QUICK_PROMPTS: QuickPrompt[] = [
  ...
  { icon: '📝', label: 'Beschreibung', message: 'Schreibe eine professionelle, verkaufsstarke Produktbeschreibung als Fließtext (2-4 Absätze, keine Aufzählungen) und liefere die Kaufargumente als Highlights.', scope: 'description,highlights' },
