          ...
          <div className="flex items-center gap-3 w-full">
            ...
            <div className="flex items-center gap-2 ml-auto">
              ...
              <div className="relative flex items-center">
                <svg className="absolute left-2 w-4 h-4 text-[color:var(--text-secondary)] pointer-events-none" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" aria-hidden="true">
                ...
                <select
                  ...
                  className="bg-[var(--surface)]/60 text-[color:var(--text-primary)] text-[13px] font-medium pl-7 pr-2 h-9 rounded-lg border border-[var(--border)] focus:outline-none focus:border-[var(--avy-purple)]/50 cursor-pointer appearance-none"
              ...
              <button
                ...
                className="w-9 h-9 flex items-center justify-center rounded-lg bg-[var(--surface)]/60 border border-[var(--border)] text-[color:var(--text-secondary)] hover:text-[color:var(--text-primary)] hover:bg-[var(--surface-hover)] transition-all"
              ...
              <button
                type="button"
                onClick={() => logout()}
                className="hidden sm:inline-flex items-center gap-1.5 rounded-lg bg-[var(--surface)]/60 border border-[var(--border)] hover:bg-[var(--surface-hover)] px-3 h-9 text-xs font-semibold text-[color:var(--text-primary)] transition-all"
              >
