...
export const Header: React.FC<HeaderProps> = ({ currentView, setView, theme, onToggleTheme }) => {
    ...
    return (
      <a
        ...
        className={`hidden sm:inline-flex items-center justify-center rounded-xl transition-all ${
          isActive
            ? 'bg-[var(--avy-purple)] text-white shadow-md shadow-[var(--avy-purple)]/20'
  ...
  return (
    <>
      <header className="safe-area-header bg-[var(--surface-secondary)]/90 backdrop-blur-xl sticky top-0 z-40 shadow-lg shadow-black/30 border-b border-[var(--border)]">
        <div className="w-full px-3 sm:px-5 lg:px-8 py-2">
          <div className="flex items-center gap-4 w-full">

            {/* Logo — scales to 7rem at large breakpoint */}
            ...
            <div className="flex items-center gap-2 ml-auto">
              ...
              <div className="relative flex items-center">
                <svg
                  className="absolute left-2.5 pointer-events-none text-[color:var(--text-secondary)]"
                ...
                <select
                  ...
                  className="bg-[var(--surface)]/70 text-[color:var(--text-primary)] font-medium pl-9 pr-3 h-10 rounded-xl border border-[var(--border)] focus:outline-none focus:border-[var(--avy-purple)]/50 cursor-pointer appearance-none"
              ...
              <button
                ...
                className="flex items-center justify-center rounded-xl bg-[var(--surface)]/70 border border-[var(--border)] text-[color:var(--text-secondary)] hover:text-[color:var(--text-primary)] hover:bg-[var(--surface-hover)] transition-all"
              ...
              <button
                type="button"
                onClick={() => logout()}
                className="hidden sm:inline-flex items-center gap-1.5 rounded-xl bg-[var(--surface)]/70 border border-[var(--border)] hover:bg-[var(--surface-hover)] px-3.5 text-[color:var(--text-primary)] transition-all"
