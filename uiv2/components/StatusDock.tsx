...
const StatusDock: React.FC<StatusDockProps> = ({
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex items-start gap-3 rounded-2xl bg-slate-900/90 border border-slate-700 px-4 py-3 shadow-xl shadow-black/40 max-w-sm">
