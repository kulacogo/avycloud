...
function buildTitleSchemaLines() {
  return [
    ...
    '8) Sport & Freizeit: [MARKE] [SPORTART] [PRODUKTART] [MAẞE] [GRÖSSE] [MODELL (nur wenn käuferrelevant)]',
...
function buildCommonPolicyText({ locale = 'de-DE', allowWebEvidence = false } = {}) {
  ...
  return [
    ...
    '- Titel: Orientiere dich an echten Top-Seller-Titeln auf ebay.de — suche ebay.de für dieses Produkt und nutze erfolgreiche Titel als Referenz.',
    '- Titel: Nur wahre, kaufrelevante Fakten. Keine irrelevanten Specs, keine falschen Informationen.',
    '- Titel: Größen (XS, S, M, L, XL, XXL) immer GROSSBUCHSTABEN.',
    '- Titel: Länge: 70–80 Zeichen (bevorzugt), Hard-Max eBay: 80 Zeichen (nie > 80).',
