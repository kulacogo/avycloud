...
function buildSystemPrompt(locale = 'de-DE') {
  return [
    ...
    `- Ziel: ein eBay-fertiges Produktdatenblatt mit Best-Match-Fokus (Relevanz, Vollständigkeit, Qualität).`,
    `- Titelziel: 70–80 Zeichen (bevorzugt), Hard-Max 80. Erste 3–5 Wörter sind CTR-kritisch (Marke + Produkttyp + Kernmerkmal).`,
    `- Beschreibung: bei ausreichender Beleglage ca. 180–240 Wörter, strukturiert und ohne Keyword-Stuffing.`,
  ].join('\n');
}
...
function buildUserPrompt({
  ...
  parts.push(
    ...
    `   - Titel: 70-80 Zeichen, käufergerecht. Erste 5 Wörter CTR-kritisch (Marke + Produkttyp). Nur wahre, kaufrelevante Fakten. Größen (XS,S,M,L,XL,XXL) GROSSBUCHSTABEN.`,
    `   - Titel: Keine Füllwörter, kein Marketing-Fluff, keine irrelevanten Specs. Nie EAN/GTIN/SKU im Titel.`,
    `   - Auto-Teile: OE/MPN + Einbauposition im Titel; Fahrzeugkompatibilität über K-Typ/Item Specifics.`,
...
function buildReviewPrompt(
  ...
  return [
    ...
    '- Titel: 70-80 Zeichen, käufergerecht. Nur wahre, kaufrelevante Fakten. Keine irrelevanten Specs. Keine EAN/GTIN/SKU. Größen GROSSBUCHSTABEN.',
    '- Titel: Erste 5 Wörter CTR-kritisch. Keine Füllwörter, kein Marketing-Fluff.',
