...
function buildUserPrompt({
  ...
  parts.push(
    ...
    `   - Titel: erste 3–5 Wörter CTR-kritisch. Platziere dort Marke + Produkttyp + wichtigstes Suchmerkmal.`,
    ...
    `   - Titel Keyword-Governance: 2-3 Kernbegriffe + max. 1-2 passende Synonym-Varianten, kein Keyword-Stuffing/keine redundanten Ketten.`,
...
function buildReviewPrompt(
  ...
  return [
    ...
    '- Titel: erste 3–5 Wörter CTR-kritisch (Marke + Produkttyp + Kernmerkmal).',
