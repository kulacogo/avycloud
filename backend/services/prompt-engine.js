 ...
 */
const { photographicStudioEnabled, STUDIO_PHOTOGRAPHY_BRIEF } = require('../lib/studio-photography');
...
function buildStudioPrompt({ product, produkt, planEntry, referenceCount = 1 }) {
  ...
  if (photographicStudioEnabled()) {
    zeilen.push(STUDIO_PHOTOGRAPHY_BRIEF, IDENTITAETS_BLOCK);
  } else zeilen.push(
