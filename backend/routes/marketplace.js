...
const {
  createJob: createBaseLinkerSyncJob,
  getJob: getBaseLinkerSyncJob,
  updateJob: updateBaseLinkerSyncJob,
  Timestamp: BaseLinkerSyncTimestamp,
} = require('../lib/baselinker-sync-jobs');
const { enqueueBaseLinkerSyncJob } = require('../services/baselinker-sync-runner');
...
router.post('/baselinker/sync/jobs', requirePermission('baselinker', 'sync'), async (req, res) => {
  try {
...
router.get('/baselinker/sync/jobs/:id', requirePermission('baselinker', 'read'), async (req, res) => {
  try {
...
router.post('/baselinker/sync/jobs/:id/retry', requirePermission('baselinker', 'sync'), async (req, res) => {
  try {
...
// =====================================================================
// BaseLinker sync (legacy + modern)
// =====================================================================

router.post('/sync-baselinker', requirePermission('baselinker', 'sync'), async (req, res) => {
...
// =====================================================================
// BaseLinker SKU/EAN lookup
// =====================================================================

router.post('/baselinker/lookup', requirePermission('baselinker', 'read'), async (req, res) => {
  try {
    const { skus } = req.body || {};
...
// =====================================================================
// BaseLinker Categories
// =====================================================================

// Search BaseLinker inventory categories (single inventory: 78659)
router.get('/baselinker/categories', requirePermission('products', 'read'), async (req, res) => {
  try {
