/**
 * One-time repair for malformed SKUs created by Identify (common: "SKU-\n123...").
 * This normalizes SKU whitespace and prefix via saveProduct(), without changing titles/key features.
 *
 * Usage:
...
async function main() {
  ...
  // Query products where sku contains whitespace or is exactly "SKU-".
  ...
  while (processed < limitTotal) {
    ...
    for (const doc of snap.docs) {
      ...
      if (!rawSku || (!hasWhitespace && !isPrefixOnly)) {
        skipped += 1;
        continue;
      }
