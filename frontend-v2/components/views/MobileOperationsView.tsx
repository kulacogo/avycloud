...
const SectionTitle: React.FC<{ title: string; desc?: string }> = ({ title, desc }) => (
  <div className="space-y-1 mb-3">
    ...
    {desc && <p className="text-sm text-[var(--text-tertiary)]">{desc}</p>}
  </div>
);
...
const ProductCard: React.FC<{ product: Product; footer?: React.ReactNode }> = ({ product, footer }) => {
  const { t } = useI18n();
  return (
  <div className="w-full text-left rounded-xl bg-[var(--surface)] border border-[var(--border)] p-3 flex gap-3 shadow-[var(--shadow-sm)]">
    ...
    <div className="flex-1">
      <p className="text-sm font-semibold text-[var(--text-primary)] line-clamp-2">{product.identification?.name}</p>
    ...
    return (
      <div className="space-y-4 max-w-xl mx-auto">
        <div className="flex items-center justify-end gap-2">
          <button
            type="button"
            className="h-11 rounded-lg bg-[var(--surface)] text-[var(--text-primary)] px-3 text-sm font-semibold border border-[var(--border)] hover:border-[var(--border-hover)] transition-colors duration-150"
        ...
        <div className="grid grid-cols-1 gap-3">
          {identifySlots.map((slot) => (
            <div key={slot} className="rounded-xl border border-dashed border-[var(--border)] bg-[var(--surface)] p-4 space-y-3">
              <div className="flex items-center justify-between gap-3">
                ...
                <button
                  type="button"
                  className="rounded-full bg-[var(--surface-secondary)] border border-[var(--border)] text-[var(--text-primary)] px-3 py-1.5 text-xs font-semibold disabled:opacity-40"
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  type="button"
                  className="rounded-xl bg-[var(--avy-purple)] text-white font-semibold py-3 hover:bg-[var(--avy-purple-hover)] transition-colors duration-150"
                ...
                <button
                  type="button"
                  className="rounded-xl bg-[var(--surface-secondary)] text-[var(--text-primary)] font-semibold py-3 border border-[var(--border)] hover:border-[var(--border-hover)] transition-colors duration-150"
              ...
              {identifyImagesBySlot[slot]?.length ? (
                <div className="space-y-2">
                  <p className="text-xs text-[var(--text-tertiary)]">{t('identifyQueue.files', { count: identifyImagesBySlot[slot].length })}</p>
              ...
              <button
                type="button"
                className="w-full rounded-xl bg-[var(--success)] text-white font-semibold py-3 disabled:opacity-40 hover:opacity-90 transition-opacity duration-150"
                disabled={!identifyImagesBySlot[slot]?.length}
                onClick={() => {
    ...
    return (
      <div className="space-y-3 max-w-xl mx-auto">
        ...
        <div className="rounded-xl border border-[var(--border)] bg-[var(--surface)] p-3 space-y-2">
          {stowMessage && <p className="text-xs text-[var(--success)]">{stowMessage}</p>}
          {stowProduct ? <ProductCard product={stowProduct} /> : null}
          <div className="grid grid-cols-2 gap-2 text-sm text-[var(--text-secondary)]">
            <div className="rounded-xl bg-[var(--surface-secondary)] border border-[var(--border)] p-2">
              <p className="text-[11px] uppercase tracking-widest text-[var(--text-tertiary)]">{t('common.sku')}</p>
              <p className="text-base font-semibold break-all">{stowSku || '—'}</p>
            </div>
            <div className="rounded-xl bg-[var(--surface-secondary)] border border-[var(--border)] p-2">
              <p className="text-[11px] uppercase tracking-widest text-[var(--text-tertiary)]">{t('common.bin')}</p>
              <p className="text-base font-semibold break-all">{stowBin || '—'}</p>
            </div>
          </div>
          {showKeypad && (
            <div className="rounded-xl bg-[var(--surface-secondary)] border border-[var(--border)] p-3 space-y-3">
              <p className="text-[11px] uppercase tracking-widest text-[var(--text-tertiary)]">{t('ops.mobile.qtyScannerOrPad')}</p>
              <div className="flex items-center gap-2">
                <input
                  ...
                  readOnly
                  value={stowQty}
                  className="flex-1 rounded-lg bg-[var(--bg)] text-[var(--text-primary)] text-xl font-semibold px-3 py-2 border border-[var(--border)] focus:border-[var(--avy-purple)] focus:shadow-[var(--shadow-focus)]"
                />
                <button
                  type="button"
                  className="rounded-lg px-3 py-2 bg-[var(--surface)] text-[var(--text-primary)] text-sm font-semibold border border-[var(--border)] hover:border-[var(--border-hover)] transition-colors duration-150"
              ...
              <div className="grid grid-cols-3 gap-2">
                {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((n) => (
                  <button
                    key={n}
                    type="button"
                    className="rounded-lg bg-[var(--surface)] text-[var(--text-primary)] text-xl font-semibold py-3 border border-[var(--border)] hover:border-[var(--border-hover)] transition-colors duration-150"
                ...
                <button
                  type="button"
                  className="rounded-lg bg-[var(--surface)] text-[var(--text-primary)] text-lg font-semibold py-3 border border-[var(--border)] hover:border-[var(--border-hover)] transition-colors duration-150"
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className="rounded-lg bg-[var(--success)] text-white font-semibold py-3 disabled:opacity-40 hover:opacity-90 transition-opacity duration-150"
            >
              {t('ops.stow.submit')}
            </button>
            <button
              ...
              className="rounded-lg bg-[var(--surface-secondary)] text-[var(--text-primary)] font-semibold py-3 border border-[var(--border)] hover:border-[var(--border-hover)] transition-colors duration-150"
            >
              {t('common.reset')}
            </button>
          </div>
        ...
        {stowEntries.length > 0 ? (
          <details className="rounded-xl border border-[var(--border)] bg-[var(--surface)] p-3">
            <summary className="cursor-pointer select-none list-none [&::-webkit-details-marker]:hidden text-sm font-semibold text-[var(--text-primary)] flex items-center justify-between">
              <span>
            ...
            <div className="mt-3 space-y-2">
              {stowEntries.map((entry, idx) => (
                <div
                  ...
                  className="rounded-xl border border-[var(--border)] bg-[var(--surface-secondary)] p-2 text-sm text-[var(--text-secondary)]"
                >
  ...
  if (mode === 'operations-pick') {
    ...
    const scanBoxClass = (kind: 'bin' | 'sku') => {
      ...
      return `rounded-xl border p-3 ${
        isExpected ? 'border-[var(--avy-purple)] bg-[var(--avy-purple-glow)]' : 'border-[var(--border)] bg-[var(--surface-secondary)]'
      }`;
    };
    ...
    return (
      <div className="max-w-xl mx-auto flex flex-col gap-3">
        <div className="flex items-end justify-between gap-3">
          <div>
            <h2 className="text-xl font-semibold text-[var(--text-primary)]">{t('ops.mode.pick')}</h2>
          </div>
          <div className="text-right text-xs text-[var(--text-tertiary)]">
            <p className="font-semibold text-[var(--text-secondary)] tabular-nums">{pickTasks.length}</p>
            <p>{t('ops.badge.pick')}</p>
          </div>
        </div>

        {ordersError ? (
          <div className="rounded-xl border border-[var(--error)]/40 bg-[var(--error-bg)] p-3 text-sm text-[var(--error)]">
            <p className="font-semibold">{t('ops.errors.ordersLoad')}</p>
            <p className="mt-1 text-xs opacity-90 break-words">{ordersError}</p>
          </div>
        ) : null}
        ...
        <div className="rounded-xl border border-[var(--border)] bg-[var(--surface)] p-3 space-y-2">
          <div className="grid grid-cols-2 gap-2">
            <div className={scanBoxClass('bin')}>
              <p className="text-[11px] uppercase tracking-widest text-[var(--text-tertiary)]">{t('common.bin')}</p>
              <p className="text-2xl font-extrabold text-[var(--text-primary)] tracking-wider break-all">
                {activeBin || `${t('ops.actions.scan')} ${t('common.bin')}`}
              </p>
            </div>
            <div className={scanBoxClass('sku')}>
              <p className="text-[11px] uppercase tracking-widest text-[var(--text-tertiary)]">{t('common.sku')}</p>
              <p className="text-base font-bold text-[var(--text-primary)] break-all">
          ...
          <div className="flex items-start justify-between gap-3">
            ...
            <button
              type="button"
              className="shrink-0 rounded-lg bg-[var(--surface-secondary)] border border-[var(--border)] px-3 py-2 text-xs font-semibold text-[var(--text-primary)] hover:border-[var(--border-hover)] transition-colors duration-150"
              onClick={() => {
                setActiveBin('');
                setActiveSku('');
                setPendingPick(null);
          ...
          {ordersLoading ? <p className="text-xs text-[var(--text-tertiary)]">{t('ops.orders.loading')}</p> : null}
        </div>
        ...
        <div className="rounded-xl border border-[var(--border)] bg-[var(--surface-secondary)] p-3">
          {pendingPick ? (
            <div className="space-y-2">
              <div className="flex items-start justify-between gap-3">
                <div className="flex-1 min-w-0 flex items-start gap-3">
                  <div className="w-12 h-12 rounded-xl bg-[var(--surface)] border border-[var(--border)] overflow-hidden flex items-center justify-center shrink-0">
                    {pendingPick.thumbnailUrl ? (
                      <img src={pendingPick.thumbnailUrl} alt="" className="w-full h-full object-cover" loading="lazy" />
                    ) : (
                      <span className="text-[11px] text-[var(--text-tertiary)]">{t('common.noImage')}</span>
                    )}
                  </div>
                  <div className="min-w-0">
                    <p className="text-sm font-semibold text-[var(--text-primary)] line-clamp-2">{pendingPick.name}</p>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="rounded-xl bg-[var(--surface-secondary)] border border-[var(--border)] p-2">
                  <p className="text-[11px] uppercase tracking-widest text-[var(--text-tertiary)]">{t('common.bin')}</p>
                  <p className="text-3xl font-extrabold text-[var(--text-primary)] tracking-wider break-all">
                    {pendingPick.binCode || '—'}
                  </p>
                </div>
                <div className="rounded-xl bg-[var(--surface-secondary)] border border-[var(--border)] p-2">
                  <p className="text-[11px] uppercase tracking-widest text-[var(--text-tertiary)]">{t('common.sku')}</p>
                  <p className="text-lg font-bold text-[var(--text-primary)] break-all">{pendingPick.sku || '—'}</p>
                </div>
              </div>
            ...
            <p className="text-sm text-[var(--text-secondary)]">{t('ops.orders.none')}</p>
          ) : nextTask ? (
            <div className="space-y-2">
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0">
                  <p className="text-sm font-semibold text-[var(--text-primary)] line-clamp-2">{nextTask.name}</p>
                  <p className="text-xs text-[var(--text-tertiary)] mt-1">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="rounded-xl bg-[var(--surface-secondary)] border border-[var(--border)] p-2">
                  <p className="text-[11px] uppercase tracking-widest text-[var(--text-tertiary)]">{t('common.bin')}</p>
                  <p className="text-3xl font-extrabold text-[var(--text-primary)] tracking-wider break-all">{nextTask.binCode || '—'}</p>
                  {nextBinGroupCount > 1 ? (
                ...
                <div className="rounded-xl bg-[var(--surface-secondary)] border border-[var(--border)] p-2">
                  <p className="text-[11px] uppercase tracking-widest text-[var(--text-tertiary)]">{t('common.sku')}</p>
                  <p className="text-base font-bold text-[var(--text-primary)] break-all">{nextTask.sku}</p>
                  <p className="text-[11px] text-[var(--text-tertiary)] mt-1">{t('ops.labels.openRemaining', { count: nextTask.remainingTotal })}</p>
                </div>
              </div>
            </div>
          ) : null}
              ...
              {pickTasks.slice(0, 100).map((task) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left rounded-xl border p-3 shadow-[var(--shadow-sm)] ${
                      isHighlighted ? 'border-[var(--avy-purple)] bg-[var(--avy-purple-glow)]' : 'border-[var(--border)] bg-[var(--surface-secondary)]'
                    }`}
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-semibold text-[var(--text-primary)] line-clamp-2">{task.name}</p>
                        <p className="text-xs text-[var(--text-tertiary)] mt-1">
                          {t('common.order')} {task.orderNumber || task.orderId}
                        </p>
                        <div className="mt-2 flex flex-wrap gap-2 text-xs">
                          <span className="px-2 py-1 rounded-full border border-[var(--border)] bg-[var(--surface)] text-[var(--text-secondary)]">
                            {t('common.sku')}: <span className="font-semibold text-[var(--text-primary)]">{task.sku}</span>
                          </span>
                          <span className="px-2 py-1 rounded-full border border-[var(--border)] bg-[var(--surface)] text-[var(--text-secondary)]">
                      ...
                      <div className="shrink-0 text-right">
                        <p className="text-[11px] uppercase tracking-widest text-[var(--text-tertiary)]">{t('common.bin')}</p>
                        <p className="text-xl font-extrabold text-[var(--text-primary)] tracking-wider">{task.binCode || '—'}</p>
                      </div>
                    </div>
                  </button>
                );
  ...
  if (mode === 'operations-pack') {
    ...
    return (
      <div className="max-w-xl mx-auto flex flex-col gap-3">
        <div className="flex items-end justify-between gap-3">
          <div>
            <h2 className="text-xl font-semibold text-[var(--text-primary)]">{t('ops.mode.pack')}</h2>
          </div>
          <div className="text-right text-xs text-[var(--text-tertiary)]">
            <p className="font-semibold text-[var(--text-secondary)] tabular-nums">{packScopedOrderKey ? scopedItems.length : packItems.length}</p>
            <p>{t('ops.badge.pack')}</p>
          </div>
        </div>

        {packMessage ? (
          <div className="rounded-xl border border-[var(--border)] bg-[var(--surface-secondary)] p-3 text-sm text-[var(--text-secondary)]">{packMessage}</div>
        ) : null}

        <div className="rounded-xl border border-[var(--border)] bg-[var(--surface)] p-3 space-y-2">
          <div className="grid grid-cols-2 gap-2">
            <div className="rounded-xl border border-[var(--border)] bg-[var(--surface-secondary)] p-3">
              <p className="text-[11px] uppercase tracking-widest text-[var(--text-tertiary)]">{t('common.order')}</p>
              <p className="text-base font-bold text-[var(--text-primary)] break-all">
        ...
        {packItems.length === 0 && !ordersLoading ? (
          <p className="text-sm text-[var(--text-tertiary)]">{t('ops.mobile.pack.none')}</p>
        ) : null}

        {selectedItem ? (
          <div className="rounded-xl border border-[var(--border)] bg-[var(--surface-secondary)] p-3 space-y-3">
            <div className="flex items-start justify-between gap-3">
              <div className="flex-1 min-w-0 flex items-start gap-3">
                <div className="w-12 h-12 rounded-xl bg-[var(--surface)] border border-[var(--border)] overflow-hidden flex items-center justify-center shrink-0">
                ...
                <div className="min-w-0">
                  <p className="text-sm font-semibold text-[var(--text-primary)] line-clamp-2">{selectedItem.name}</p>
                  <p className="text-xs text-[var(--text-tertiary)] mt-1">
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              <div className="rounded-xl bg-[var(--surface-secondary)] border border-[var(--border)] p-2">
                <p className="text-[11px] uppercase tracking-widest text-[var(--text-tertiary)]">{t('common.bin')}</p>
                <p className="text-lg font-bold text-[var(--text-primary)] break-all">{selectedItem.binCode || '—'}</p>
              </div>
              <div className="rounded-xl bg-[var(--surface-secondary)] border border-[var(--border)] p-2">
                <p className="text-[11px] uppercase tracking-widest text-[var(--text-tertiary)]">{t('common.qty')}</p>
                <p className="text-lg font-extrabold text-[var(--text-primary)] tabular-nums">{selectedItem.qty}</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                type="button"
                className="h-14 rounded-xl bg-[var(--success)] text-white font-extrabold text-lg hover:opacity-90 transition-opacity duration-150"
                onClick={submitPack}
              >
                Verpackt
              </button>
              <button
                type="button"
                className="h-14 rounded-xl bg-[var(--surface)] text-[var(--text-primary)] font-semibold text-lg border border-[var(--border)] hover:border-[var(--border-hover)] transition-colors duration-150"
          ...
          <div className="rounded-xl border border-[var(--border)] bg-[var(--surface-secondary)] p-3 space-y-3">
            <p className="text-sm text-[var(--text-secondary)]">Scan Auftrag oder SKU, um zu starten.</p>
            <button
              type="button"
              className="h-14 rounded-xl bg-[var(--surface)] text-[var(--text-primary)] font-semibold text-lg border border-[var(--border)] hover:border-[var(--border-hover)] transition-colors duration-150"
              onClick={() => cycleSelection(1)}
  ...
  return (
    <div className="space-y-4 max-w-xl mx-auto">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-[var(--text-primary)]">{t('ops.title')}</h1>
          <p className="text-[var(--text-tertiary)] text-sm">{t('ops.subtitle')}</p>
        </div>
        <div className="text-right text-xs text-[var(--text-tertiary)] space-y-0.5">
          <p>
      ...
      <div className="flex flex-col gap-3">
        <button
          type="button"
          className="w-full rounded-xl bg-[var(--avy-purple)] text-white font-semibold py-4 text-lg hover:bg-[var(--avy-purple-hover)] transition-colors duration-150"
        ...
        <button
          type="button"
          className="w-full rounded-xl bg-[var(--success)] text-white font-semibold py-4 text-lg hover:opacity-90 transition-opacity duration-150"
        ...
        <button
          type="button"
          className="w-full rounded-xl bg-[var(--warning)] text-white font-semibold py-4 text-lg hover:opacity-90 transition-opacity duration-150"
        ...
        <button
          type="button"
          className="w-full rounded-xl bg-[var(--surface-secondary)] text-[var(--text-primary)] font-semibold py-4 text-lg border border-[var(--border)] hover:border-[var(--border-hover)] transition-colors duration-150"
